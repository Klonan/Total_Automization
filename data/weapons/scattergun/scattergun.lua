...
local path = util.path("data/weapons/scattergun/")
local gun = util.base_gun(names.scattergun)
gun.icon = path.."scattergun.png"
gun.icon_size = 512
gun.stack_size = 1
gun.attack_parameters =
{
  ...
  {
    {
      filename = path.."scattergun_shoot.ogg"
    }
  }
}
...
local make_shotgun_blast = function(speed, direction, range, count)
  return
  {
    ...
    {
      type = "projectile",
      projectile = names.scattergun.." Projectile",
...
local ammo = util.base_ammo(names.scattergun)
ammo.icon = path.."scattergun_ammo.png"
ammo.icon_size = 256
ammo.reload_time = SU(213.6 - 37.5)
...
projectile.name = names.scattergun.." Projectile"
projectile.action =
{
  type = "direct",
  action_delivery =
